...
*/
    ...
    $("#nestle_visual").click(function(){
        console.log("sd")
        var lable = $("#nestle_visual").text().trim();
        if(lable == "visualize data") {

            $("#nestle_visual").text("Hide");
            $("#nestle_graph").slideDown()
         
          }
          else {
            
            $("#nestle_visual").text("visualize data");
            $("#nestle_graph").slideUp()
            console.log("done")
      ...
      $("#pia_visual").click(function(){
        console.log("sd")
        var lable = $("#pia_visual").text().trim();
        if(lable == "visualize data") {

            $("#pia_visual").text("Hide");
            $("#pia_graph").slideDown()
         
          }
          else {
            
            $("#pia_visual").text("visualize data");
            $("#pia_graph").slideUp()
            console.log("done")
      ...
      $("#netsol_visual").click(function(){
        console.log("sd")
        var lable = $("#netsol_visual").text().trim();
        if(lable == "visualize data") {

            $("#netsol_visual").text("Hide");
            $("#netsol_graph").slideDown()
         
          }
          else {
            
            $("#netsol_visual").text("visualize data");
            $("#netsol_graph").slideUp()
            console.log("done")
      ...
      $("#allied_visual").click(function(){
        console.log("sd")
        var lable = $("#allied_visual").text().trim();
        if(lable == "visualize data") {

            $("#allied_visual").text("Hide");
            $("#allied_graph").slideDown()
         
          }
          else {
            
            $("#allied_visual").text("visualize data");
            $("#allied_graph").slideUp()
            console.log("done")
      ...
      $("#abbs_visual").click(function(){
        console.log("sd")
        var lable = $("#abbs_visual").text().trim();
        if(lable == "visualize data") {

            $("#abbs_visual").text("Hide");
            $("#abbs_graph").slideDown()
         
          }
          else {
            
            $("#abbs_visual").text("visualize data");
            $("#abbs_graph").slideUp()
            console.log("done")
